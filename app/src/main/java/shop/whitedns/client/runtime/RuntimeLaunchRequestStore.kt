...
object RuntimeLaunchRequestStore {
    ...
    internal fun decodeSettings(json: JSONObject): WhiteDnsSettings {
        ...
        val settings = WhiteDnsSettings(
			...
			uploadDuplication = json.optString("uploadDuplication", "1"),
			downloadDuplication = json.optString("downloadDuplication", "1"),
			...
			pingWatchdogSeconds = json.optString("pingWatchdogSeconds", "30"),
