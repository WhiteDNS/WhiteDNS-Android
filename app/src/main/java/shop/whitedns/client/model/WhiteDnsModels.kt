...
data class WhiteDnsSettings(
	...
	val uploadDuplication: String = "1",
	val downloadDuplication: String = "1",
	...
	val pingWatchdogSeconds: String = "30",
...
fun WhiteDnsSettings.resolve(): ResolvedWhiteDnsSettings {
    ...
    return ResolvedWhiteDnsSettings(
		...
		uploadDuplication = boundedInt(uploadDuplication, defaultValue = 1, minValue = 1, maxValue = 30),
		downloadDuplication = boundedInt(downloadDuplication, defaultValue = 1, minValue = 1, maxValue = 30),
		...
		pingWatchdogSeconds = boundedInt(pingWatchdogSeconds, defaultValue = 30, minValue = 0, maxValue = 3600),
